...
export default class PDFExample extends React.Component {
    ...
    download() {
        var date = new Date();
        var url = "https://fusionhealthcare.com.br/assets/images/gama/gama_logo_colorido.png";
        ...
        console.warn('#############picture dir: ' + options.addAndroidDownloads.path);
    ...
    render() {
        let source = {uri:'https://www.ets.org/Media/Tests/TOEFL/pdf/SampleQuestions.pdf',cache:true};
        ...
        return (
            <View style={styles.container}>
                <View style={{flexDirection: 'row'}}>
                    ...
                    <TouchableHighlight style={styles.btn} onPress={() => this.requestCameraPermission()}>
